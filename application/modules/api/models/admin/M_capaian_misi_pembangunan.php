...
class M_capaian_misi_pembangunan extends CI_Model 
{
	public $primary		= 'id';
    public $tbl_name	= 'tbl_capaian_misi_pembangunan';
   
    public function get_all($periode, $limit, $offset) 
    {
        $this->db->where('periode', $periode);
		$this->db->group_by('misi');
