					...
					<table id="table" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="text-center h5" id="table-title" colspan="4">Tahun <i class="small">( ribu rupiah )</i></th>
							</tr>
							<tr id="list-year">
...
<script>
	...
	$( ".add" ).on( "click", function(event) {
		...
		if(value == null){
		$('#title-add').html('Insert Garis Kemiskinan '+year);
		}else{
		$('#title-add').html('Update Garis Kemiskinan '+year);		
		}
		$('#name-add').html("Garis Kemiskinan "+name);
