...
class M_jumlah_penduduk_menurut_jenis_kegiatan extends CI_Model 
{
	public $primary		= 'id';
    public $tbl_name	= 'tbl_jumlah_penduduk_menurut_jenis_kegiatan';
   
    public function get_all($limit, $offset) 
    {
        $this->db->group_by('jenis_kegiatan');
	...
	public function get_items($year, $end, $like) 
    {
		...
		$this->db->where('jenis_kegiatan', $like);
   ...
   public function update_name($id, $data)
    {       
        ...
        $result = $this->db->get($this->tbl_name);
		$result = $result->row_array();
		$name 	= $result['jenis_kegiatan'];
		
		$this->db->where('jenis_kegiatan', $name);
         $this->db->update($this->tbl_name, $data);
