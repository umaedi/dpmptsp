					...
					<table id="table" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="text-center h5" id="table-title" colspan="4">Tahun <i class="small">( dalam persen % )</i></th>
...
<script>
	...
	$( ".add" ).on( "click", function(event) {
		...
		if(value == null){
		$('#title-add').html('Insert PDRB Tahun '+year);
		}else{
		$('#title-add').html('Update PDRB Tahun '+year);		
		}
	...
	$( ".opt" ).on( "click", function(event) {
		...
		var name = $(this).data("name");
		$('#title-insert').html('Update uraian PDRB');
