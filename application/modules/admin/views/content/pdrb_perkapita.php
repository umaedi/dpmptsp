...
<script> 
	...
	$( ".opt" ).on( "click", function(event) {
		...
		$('#title-insert').html('Update PDRB Perkapita '+tahun);
	...
	function insert(){
		...
		$("input[name=id]").val('');
		$('#modal_insert').find('#form-insert')[0].reset();
		$('#title-insert').html('Insert PDRB Perkapita');
		$('#name-insert').html('Anda akan menambahkan tahun PDRB Perkapita baru');
		$("#modal_insert").modal("show");
