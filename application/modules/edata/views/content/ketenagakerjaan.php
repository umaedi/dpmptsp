		...
		$.ajax({
                    ...
                    complete: function(response){                
                        if(response.status == 200){
							...
							if(response.responseJSON._meta.pinStatus == true){ var pin = '<i class="icon-check text-success"></i>Show on E-Data'; }else{ var pin = '<i class="icon-pushpin"></i>Pin to E-Data';};
							$('#pin-status').html(pin); 
