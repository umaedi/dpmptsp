					...
					<table id="table" class="table table-bordered table-striped table-hover">
						<thead>
							<tr>
								...
								<th class="text-center h5" id="table-title" colspan="4">Tahun <i class="small">( persen )</i></th>
							</tr>
							<tr id="list-year">
...
<script>
	...
	$( ".add" ).on( "click", function(event) {
		...
		if(value == null){
		$('#title-add').html('Insert Tingkat Kemiskinan '+year);
		}else{
		$('#title-add').html('Update Tingkat Kemiskinan '+year);		
		}
		$('#name-add').html("Tingkat Kemiskinan "+name);
	...
	$( ".opt" ).on( "click", function(event) {
		...
		var name = $(this).data("name");
		$('#title-insert').html('Update Kabupaten / Kota');
		$('#name-insert').html('Anda akan merubah kabupaten / kota '+name);
		$("input[name=id]").val(id);
		$("input[name=name]").val(name);
	...
	function insert(){
		...
		$("input[name=year]").val(year);
		$('#modal_insert').find('#form-insert')[0].reset();
		$('#title-insert').html('Insert Kabupaten / Kota');
		$('#name-insert').html('Anda akan menambahkan Kabupaten / Kota baru');
		$("#modal_insert").modal("show");
