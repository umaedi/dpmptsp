...
class M_luas_penggunaan_lahan extends CI_Model 
{
	public $primary		= 'id';
    public $tbl_name	= 'tbl_luas_penggunaan_lahan';
   
    public function get_all($limit, $offset) 
    {
        $this->db->group_by('luas_penggunaan_lahan');
	...
	public function get_items($year, $end, $like) 
    {
		...
		$this->db->like('luas_penggunaan_lahan', $like);
    ...
    public function update_name($id, $data)
    {
		...
		$name 	= $result['luas_penggunaan_lahan'];
		
		$this->db->where('luas_penggunaan_lahan', $name);
        $this->db->update($this->tbl_name, $data);
